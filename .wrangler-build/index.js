...
async function hasValidTurnstileSession(request, env) {
  ...
  const [expiresAt, sig] = match2[1].split(".");
...
async function onRequest2(context) {
  ...
  if (!isProxyPath && isTurnstileEnabled(env) && !await hasValidTurnstileSession(request, env)) {
    if (request.method === "OPTIONS") {
      return next();
    }
...
// .wrangler/tmp/pages-oGPmj6/functionsRoutes-0.41598964636134683.mjs
var routes = [
  {
    routePath: "/functions/proxy/:path*",
    mountPath: "/functions/proxy",
    method: "",
    middlewares: [],
    modules: [onRequest]
  },
...
// ../../../../envs/npm/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../envs/npm/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
